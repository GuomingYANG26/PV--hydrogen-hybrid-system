...
lambda_air1 = np.linspace(0,20,21)      #政府重视PV程度
lambda_air2 = np.linspace(0,20,21)      #政府重视H2程度
df0 = pd.DataFrame()                    #保存obj
df1 = pd.DataFrame()                    #保存变电站容量
df2 = pd.DataFrame()                    #保存电解槽容量
df3 = pd.DataFrame()                    #保存售氢收益
df4 = pd.DataFrame()                    #保存售电收益
df5 = pd.DataFrame()                    #保存环境效益
